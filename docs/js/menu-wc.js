...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">experimento documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/AdminproductosComponent.html" data-type="entity-link" >AdminproductosComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Nabvar2Component.html" data-type="entity-link" >Nabvar2Component</a>
                            </li>
                            <li class="link">
